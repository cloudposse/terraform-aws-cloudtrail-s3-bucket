...
whereas the S3 bucket to store the CloudTrail logs is created in the Audit AWS account, allowing access to the logs only to the users/groups from the Audit account.
